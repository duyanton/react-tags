...
var ReactTags = function (_Component) {
  ...
  _createClass(ReactTags, [{
    ...
    value: function render() {
      ...
      if (customInput && _react2.default.isValidElement(customInput)) {
        tagInput = customInput;
      } else {
        tagInput = !this.props.readOnly ? _react2.default.createElement(
          'div',
...
ReactTags.PropTypes = {
  ...
  customInput: _propTypes2.default.number
};
